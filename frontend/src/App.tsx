...
const StudentFormPage = lazy(
    () => import("./features/students/pages/StudentFormPage"),
);
...
const TeacherFormPage = lazy(
    () => import("./features/teachers/pages/TeacherFormPage"),
);
const TeacherDetailPage = lazy(
    () => import("./features/teachers/pages/TeacherDetailPage"),
);

const AcademicYearsList = lazy(
    () => import("./features/academicYear/pages/AcademicYearsList"),
);
const AcademicYearDetail = lazy(
    () => import("./features/academicYear/pages/AcademicYearDetail"),
);
const ExamDetail = lazy(
    () => import("./features/academicYear/pages/ExamDetail"),
);

const SubjectsList = lazy(
    () => import("./features/subjects/pages/SubjectsList"),
);
...
const GradeBandsList = lazy(
    () => import("./features/gradeBands/pages/GradeBandsList"),
);

const StudentDashboardPage = lazy(
    () => import("./features/studentPortal/pages/StudentDashboardPage"),
);
const StudentMarksPage = lazy(
    () => import("./features/studentPortal/pages/StudentMarksPage"),
);
const StudentSubjectsPage = lazy(
    () => import("./features/studentPortal/pages/StudentSubjectsPage"),
);
const StudentReportPage = lazy(
    () => import("./features/studentPortal/pages/StudentReportPage"),
);
const StudentProfilePage = lazy(
    () => import("./features/studentPortal/pages/StudentProfilePage"),
);

const AdminDashboardPage = lazy(
    () => import("./features/dashboard/pages/AdminDashboardPage"),
);
const MarkSheetListPage = lazy(
    () => import("./features/markSheets/pages/MarkSheetListPage"),
);
const MarkSheetDetailPage = lazy(
    () => import("./features/markSheets/pages/MarkSheetDetailPage"),
);
const ReportsPage = lazy(() => import("./features/reports/pages/ReportsPage"));

const TeacherDashboardPage = lazy(
    () => import("./features/teacherPortal/pages/TeacherDashboardPage"),
);
const TeacherClassesPage = lazy(
    () => import("./features/teacherPortal/pages/TeacherClassesPage"),
);
const TeacherStudentsPage = lazy(
    () => import("./features/teacherPortal/pages/TeacherStudentsPage"),
);
const GradebookPage = lazy(
    () => import("./features/teacherPortal/pages/GradebookPage"),
);
const TeacherMarksheetsPage = lazy(
    () => import("./features/teacherPortal/pages/TeacherMarksheetsPage"),
);
const TeacherMarksheetDetailPage = lazy(
    () => import("./features/teacherPortal/pages/TeacherMarksheetDetailPage"),
);
const TeacherProfilePage = lazy(
    () => import("./features/teacherPortal/pages/TeacherProfilePage"),
);
                ...
                <Routes>
                    ...
                    >
                        ...
                        <Route
                            ...
                            element={
                                <ProtectedRoute
                                    allowedRoles={[USER_ROLES.SCHOOL_ADMIN]}
                                >
                                    <Outlet />
                                </ProtectedRoute>
                            }
                        >
                            ...
                            <Route
                                path="grade-bands"
                                element={<GradeBandsList />}
                            />
                            <Route
                                path="marksheets"
                                element={<MarkSheetListPage />}
                            />
                            <Route
                                path="marksheets/:id"
                                element={<MarkSheetDetailPage />}
                            />
